...
export function RegenerateNewsBanner({ token }: Props) {
  ...
  return (
    <div className="mb-8 rounded-md border border-amber-200/80 bg-amber-50/90 px-5 py-4">
      <p className="font-sans text-sm font-medium text-amber-950">
        This edition has short summaries, not full synopses.
      </p>
      <p className="mt-1 font-sans text-sm text-amber-900/80">
        Regenerate today&apos;s briefing to get 280+ word synopses with numbers
        and context—you won&apos;t need to open every link.
      </p>
      <button
        type="button"
        onClick={regenerate}
